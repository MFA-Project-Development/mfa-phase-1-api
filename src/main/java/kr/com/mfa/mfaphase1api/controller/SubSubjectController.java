...
public class SubSubjectController {
    ...
    @AuditAction("CREATE_SUB_SUBJECT")
    ...
    public ResponseEntity<APIResponse<SubSubjectResponse>> createSubSubject(
        ...
        return buildResponse(
                "SubSubject created",
                subSubjectService.createSubSubject(subjectId, request),
                HttpStatus.CREATED
        );
    }
    ...
    public ResponseEntity<APIResponse<SubSubjectResponse>> getSubSubjectById(
        ...
        return buildResponse(
                "SubSubject retrieved",
                subSubjectService.getSubSubjectById(subjectId, subSubjectId),
                HttpStatus.OK
        );
    }

    @AuditAction("UPDATE_SUB_SUBJECT")
    @PreAuthorize("hasRole('ADMIN')")
    ...
    public ResponseEntity<APIResponse<SubSubjectResponse>> updateSubSubjectById(
        ...
        return buildResponse(
                "SubSubject updated",
                subSubjectService.updateSubSubjectById(subjectId, subSubjectId, request),
                HttpStatus.OK
        );
    }

    @AuditAction("DELETE_SUB_SUBJECT")
    @PreAuthorize("hasRole('ADMIN')")
